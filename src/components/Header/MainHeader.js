      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="flex justify-center items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              <h1 className="animate__animated animate__fadeInTopLeft max-w-lg mx-auto lg:mx-0 text-3xl md:text-5xl font-bold mb-5 text-gray-900">
          ...
          <div
            data-aos="fade-left"
            data-aos-duration="2000"
            className=" w-full lg:w-1/2 hidden lg:flex justify-center mr-6"
          >
            <div className="rounded-3xl border border-gray-700 header-carousel-box shadow-2xl overflow-hidden">
              ...
              >
                <div className="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
                  ...
                  >
                    <img src={Logo} className="block w-full" alt="hdp1" />
                  </div>
                  ...
                  <div
                    ...
                    data-te-carousel-item
                  >
                    <img src={Logo2} className="block w-full" alt="hdp2" />
                  </div>
                  ...
                  <div
                    ...
                    data-te-carousel-item
                  >
                    <img src={Logo3} className="block w-full" alt="hdp3" />
                  </div>
                </div>
              </div>
            </div>
